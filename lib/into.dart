              ...
              children: [
                ...
                TextSpan(
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTap = () {
                      launch(
                        "https://github.com/Mangielijah/gotrue-dart",
                      );
                    },
                  style: const TextStyle(
                    decoration: TextDecoration.underline,
                ...
                TextSpan(
                  text: "deploy a copy of this website to Netlify",
                  recognizer: TapGestureRecognizer()
                    ..onTap = () {
                      launch(
                        "https://github.com/Mangielijah/gotrue-dart-playground",
                      );
                    },
                  style: const TextStyle(
                    decoration: TextDecoration.underline,
...
class _IdentityApiFormState extends State<IdentityApiForm> {
  TextEditingController controller = TextEditingController(
    text: "<ENTER YOUR NETLIFY URL>/.netlify/identity",
  );
